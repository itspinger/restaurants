...
public class TestDataRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        this.createType("Client created a reservation", "Hello Mr. %s, a user has just created a reservation at %s time and table %s");
        ...
        this.createType("Client cancelled a reservation", "Hello Mr. %s, a user has just cancelled their reservation for table %s at time %s");
        this.createType("Manager cancelled your reservation", "Hello %s, we're sorry to inform you that the manager has cancelled your reservation for table %s at time %s");
